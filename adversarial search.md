...
后辈**极小节点上界小于祖辈极大节点下界 $\alpha$ 剪** or 后辈**极大节点下界大于祖辈极小节点上界**
...
基于演员-评价的强化学习, 强调的是重要行棋点的学习, 通过收益增量 对走法的重要性进行评价, 学习到的是每个落子点获得最大收益增量的概率
